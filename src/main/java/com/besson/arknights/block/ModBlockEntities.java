...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<CheckerboardBookcaseBE> CHECKERBOARD_BOOKCASE = create("checkerboard_bookcase",
            BlockEntityType.Builder.create(CheckerboardBookcaseBE::new,
                    ...
                    ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_BBL, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_BBR, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_BTL, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_BTR,
                    ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_MBL, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_MBR, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_MTL, ModBlocks.ORANGE_CHECKERBOARD_BOOKCASE_MTR,
