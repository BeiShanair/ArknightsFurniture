...
public class OrangeSimpleDesk extends FurnitureHorizontalFacingBlock {
    public OrangeSimpleDesk(Settings settings) {
        super(settings);
    }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        ...
        world.setBlockState(lbr, ModBlocks.SIMPLE_ORANGE_DESK_LBR.getDefaultState().with(FACING, dir));
        world.setBlockState(ltl, ModBlocks.SIMPLE_ORANGE_DESK_LTL.getDefaultState().with(FACING, dir));
        world.setBlockState(ltr, ModBlocks.SIMPLE_ORANGE_DESK_LTR.getDefaultState().with(FACING, dir));
        world.setBlockState(rbl, ModBlocks.SIMPLE_ORANGE_DESK_RBL.getDefaultState().with(FACING, dir));
        world.setBlockState(rbr, ModBlocks.SIMPLE_ORANGE_DESK_RBR.getDefaultState().with(FACING, dir));
        world.setBlockState(rtl, ModBlocks.SIMPLE_ORANGE_DESK_RTL.getDefaultState().with(FACING, dir));
        world.setBlockState(rtr, ModBlocks.SIMPLE_ORANGE_DESK_RTR.getDefaultState().with(FACING, dir));
    }
    ...
    private BlockPos findMainBlockPosition(BlockState state, BlockPos pos) {
        if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LBL)){
            return pos;
        }
        Direction dir = state.get(FACING);
        if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LBR)){
            return pos.offset(dir.rotateYClockwise());
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LTL)) {
            return pos.offset(dir);
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LTR)) {
            return pos.offset(dir.rotateYClockwise()).offset(dir);
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RBL)) {
            return pos.offset(dir.rotateYClockwise(), 2);
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RBR)) {
            return pos.offset(dir.rotateYClockwise(), 3);
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RTL)) {
            return pos.offset(dir.rotateYClockwise(), 2).offset(dir);
        } else if (state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RTR)) {
    ...
    private boolean isDesk(BlockState state){
        return state.isOf(this) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LBL) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LBR) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LTL) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_LTR) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RBL) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RBR) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RTL) ||
                state.isOf(ModBlocks.SIMPLE_ORANGE_DESK_RTR);
    }
}
