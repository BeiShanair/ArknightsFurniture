...
public class LogCabinetTop extends ModAbstractChestBlock<LogCabinetTopBE> {


    public LogCabinetTop(Settings settings, Supplier<BlockEntityType<? extends LogCabinetTopBE>> blockEntityTypeSupplier) {
